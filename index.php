          ...
          <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 pt-4 pt-lg-0 content">
                      ...
                      <p class="font-italic">
                          Daha öncesinde farklı yerlerden hizmet alıp memnun kalmadığınızı biliyoruz. Merak etmeyin
                          artık emin
                          ellerdesiniz..
                      </p>
                      <ul>
                  ...
                  ?>margin-bottom: 4%;" src="<?php echo $eklenticek['eklenti_resim'];?>"></div>
                          ...
                          <div style="height: 70px; overflow:hidden; text-overflow:ellipsis; margin-bottom: 3%;">
                              <p style="padding-left: 5%; padding-right: 5%;">
                                  <?php echo $eklenticek['eklenti_aciklama'];?></p>
                          </div>

                          <div align="center">
                              <a href="eklenti?eklentiid=<?php echo $eklenticek['eklenti_id'];?>"><button
                                      style="margin-top: 10%; margin-bottom: 0%;" type="submit"
                                      class="col-md-6 btn btn-primary"><b>Devamını Gör</b></button></a>
                          </div>
              ...
              while($eklenticek=$eklentisor->fetch(PDO::FETCH_ASSOC))
                {?>
                  ...
                  <div align="center" style="margin-top: 5%;">
                      <a href="eklentiler"><button type="submit" class="col-md-3 btn btn-success"><b>Tümünü
                                  Gör</b></button></a>
                  </div>
