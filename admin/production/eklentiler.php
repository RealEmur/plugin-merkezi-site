                      ...
                      while($eklenticek=$eklentisor->fetch(PDO::FETCH_ASSOC))
                        {?>
                         <tr class="even pointer">
                          <td><img style="width: 150px;" src="<?php echo $eklenticek['eklenti_resim']?>"></td>
                          <td style="text-align: center;"><?php echo $eklenticek['eklenti_isim']?></td>
                          <td style="text-align: center;" class=""><?php echo $eklenticek['eklenti_aciklama']?></td>
                          <td style="text-align: center;" class=""><?php echo $eklenticek['eklenti_fiyat']?></td>
