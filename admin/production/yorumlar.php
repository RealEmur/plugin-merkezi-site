                  ...
                  while($yorumcek=$yorumsor->fetch(PDO::FETCH_ASSOC))
                    {?>
                     <tr class="even pointer">
                      ...
                      <td style="text-align: center;" class=" "><a href="yorum-duzenle.php?yorumid=<?php echo $yorumcek['yorum_id']?>"><button style="width: 70px; "class="btn btn-primary btn-xs"><i class="success fa fa-edit"> Düzenle</i></button></td></a>
                      ...
                      <form action="../veritabani/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <td class=" "><button name="yorumsil" style="width: 70px; "class="btn btn-danger btn-xs"><i class="success fa fa-trash"> Sil</i></button></td>
                      </form>
                    </tr>
                  <?php } ?>
                </tbody>
