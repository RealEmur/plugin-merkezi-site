            ...
            <h2>Genel Ayarlar <small>
              ...
              <div class="x_content">
                ...
                <form action="../veritabani/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="footer_resim" value="<?php echo $footercek['footer_resim']?>" type="text" id="first-name" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="footer_baslik" value="<?php echo $footercek['footer_baslik']?>" type="text" id="first-name" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                   <textarea name="footer_aciklama" class="resizable_textarea form-control" placeholder="Açıklama içeriğini yazın."><?php echo $footercek['footer_aciklama']?></textarea>
                 </div>
               </div>
