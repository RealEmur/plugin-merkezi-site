            ...
            <form action="../veritabani/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="admin_kullanici" type="text" placeholder="Kullanıcı adını giriniz" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="admin_sifre" type="text" placeholder="Şifreyi giriniz" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div style="margin-left: 22%;margin-top: 3%;">
                ...
                <?php if(yetkikontrol2($_SESSION['pmadmin_kullaniciadi'], "yetki_eklenti")){ ?>
                  <label style="margin-left: 5%; margin-bottom: 5%;">
                    <input type="checkbox" name="yetki_eklenti" value="1" class="js-switch"/> Eklentiler
                  </label>
                <?php }if(yetkikontrol2($_SESSION['pmadmin_kullaniciadi'], "yetki_kullanici")){ ?>
                  <label style="margin-left: 5%; margin-bottom: 5%;">
                    <input type="checkbox" name="yetki_kullanici" value="1" class="js-switch"/> Kullanıcılar
                  </label>
                ...
                <?php }if(yetkikontrol2($_SESSION['pmadmin_kullaniciadi'], "yetki_genel")){ ?>
                  <label style="margin-left: 5%; margin-bottom: 5%;">
                    <input type="checkbox" name="yetki_genel" value="1" class="js-switch"/> Genel Ayarlar
                  </label>
              ...
              <div align="center" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="yenikullaniciekle" class="btn btn-success">Kullanıcı Ekle</button>
              </div>
