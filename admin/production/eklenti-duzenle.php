            ...
            <form action="../veritabani/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="eklenti_isim" type="text" value="<?php echo $eklenticek['eklenti_isim'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="eklenti_resim" type="text" value="<?php echo $eklenticek['eklenti_resim'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="eklenti_aciklama" class="resizable_textarea form-control"><?php echo $eklenticek['eklenti_aciklama'];?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="eklenti_fiyat" type="text" value="<?php echo $eklenticek['eklenti_fiyat'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="eklenti_sira" type="text" value="<?php echo $eklenticek['eklenti_sira'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="eklenti_durum" value="<?php echo $eklenticek['eklenti_durum'];?>" id="heard" class="form-control" required>
              ...
              <div align="center" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="eklentiduzenle" class="btn btn-success">Eklentiyi Düzenle</button>
              </div>
