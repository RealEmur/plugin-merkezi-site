          ...
          <div class="x_content">
            ...
            <form action="../veritabani/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="yorum_rol" type="text" value="<?php echo $yorumcek['yorum_rol'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="yorum_aciklama" type="text" value="<?php echo $yorumcek['yorum_aciklama'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="yorum_sira" type="text" value="<?php echo $yorumcek['yorum_sira'];?>" id="first-name" class="required form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div align="center" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="yorumduzenle" class="btn btn-success">Yorumu Düzenle</button>
              </div>
