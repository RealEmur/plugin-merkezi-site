                    ...
                    <div class="x_content">
                        ...
                        <form action="../veritabani/islem.php" method="POST" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="yorum_steamdec" type="text"
                                        placeholder="Yorum sahibinin steamdec adresi" id="first-name"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="yorum_yazici" type="text"
                                        placeholder="Yorum sahibinin nickini yazınız steamdec dolu ise boş bırakabilirsiniz"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="yorum_resim" type="text"
                                        placeholder="Kullanılmasını istediğiniz linki yazınız steamdec dolu ise boş bırakabilirsiniz"
                                        id="first-name" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="yorum_rol" type="text" placeholder="Sunucu ismini giriniz"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="yorum_aciklama" type="text" placeholder="Yapılan yorumu yazınız"
                                        id="first-name" class="required form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="yorum_sira" type="text" value="0" id="first-name"
