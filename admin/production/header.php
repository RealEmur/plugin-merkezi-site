                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img style="border:2px solid #ffffff; border-radius: 10px; box-shadow: 0 0 10px; margin-left: 25px; margin-top: 25px; width: 50px; height: 50px;"
                                src="<?php echo $_SESSION['pmadmin_foto'];?>" alt="" class=" profile_img">
                        </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="<?php echo $_SESSION['pmadmin_foto'];?>"
                                        alt=""><?php echo $_SESSION['pmadmin_kullaniciadi'];?>
                                    <span class=" fa fa-angle-down"></span>
                                </a>
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li><a href="profil.php"><i class="fa fa-user pull-right"></i> Profil</a></li>
                                    <li><a href="guvenlicikis"><i class="fa fa-sign-out pull-right"></i> Güvenli
                                            Çıkış</a></li>
                                </ul>
                            </li>
                        </ul>
