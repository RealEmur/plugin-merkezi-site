    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <a href="kullanici-ekle"><button class="btn btn-success btn-xs"><i class="success fa fa-plus"> Yeni
                            Yetkili Ekle</i></button></a>
                <small>
            ...
            ?>" src="<?php echo $admincek['admin_resim']; ?>">
                ...
                <form action="../veritabani/islem" method="POST" style="margin-top: 5%;">
                    <label style="margin-left: 5%; margin-bottom: 5%;">
                        <input type="checkbox" name="yetki_eklenti" value="1" class="js-switch" <?php 
